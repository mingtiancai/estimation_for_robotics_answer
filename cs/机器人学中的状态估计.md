...
\right] = \left[
\begin{matrix}
 x_{k-1}+Tv_{k}cos \theta_{k-1}+\omega_{xk}     \\
 y_{k-1}+T\omega_{k}sin \theta_{k-1}+\omega_{yk}     \\
 \theta_{k-1}+T\omega_{k}+\omega_{\theta k}     \\
\end{matrix}
\right] $  
...
$G_{k}=\left[
\begin{matrix}
 &\frac{x_{k}}{\sqrt{x_{k}^{2}+y_{k}^{2}}}  &\frac{y_{k}}{\sqrt{x_{k}^{2}+y_{k}^{2}}}  &0    \\
 &\frac{-y_{k}}{\sqrt{x_{k}^{2}+y_{k}^{2}}}   &\frac{x_{k}}{\sqrt{x_{k}^{2}+y_{k}^{2}}}  &-1 \\
\end{matrix}\right]$   

$\boldsymbol{n_{k}^{'}}=\boldsymbol{n_{k}}$

$Q_{k}^{'}=E(\omega_{k}^{'}\omega_{k}^{'T})=Q$
