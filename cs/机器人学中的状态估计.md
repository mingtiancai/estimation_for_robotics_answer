...
$(Cu)^{\wedge}=cos\thetau^{\wedge}+(1-cos\theta)(u^{\wedge}-u^{\wedge}aa^{T}-aa^{T}u^{\wedge})+sin\theta(a^{\wedge}u^{\wedge}-u^{\wedge}a^{\wedge})=(2cos\theta+1)u^{\wedge}-u^{\wedge}C-C^{T}u^{\wedge}$  
